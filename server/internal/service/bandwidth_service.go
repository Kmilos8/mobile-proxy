...
func (s *BandwidthService) GetTotalToday(ctx context.Context) (int64, int64, error) {
	return s.bwRepo.GetTotalToday(ctx)
}

func (s *BandwidthService) GetTotalMonth(ctx context.Context) (int64, int64, error) {
	now := time.Now()
